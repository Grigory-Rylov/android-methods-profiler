...
public class ZoomAndPanDelegate implements MouseListener, MouseMotionListener, MouseWheelListener {
...
//        showMatrix(inverse);
    ...
    public static class LeftTopBounds implements ScrollBoundsStrategy {
        ...
        public Point2D correctOffset(double dx, double dy, Rectangle2D transformedScreenBounds, Point2D dataRightBottom) {
            ...
            if (dy > 0) { // pane down
                dy = Math.min(dy, transformedScreenBounds.getMinY());
            }
