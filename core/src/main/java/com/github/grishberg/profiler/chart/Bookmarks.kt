...
class Bookmarks {
     ...
     * @param logger
     */
    constructor(traceFileName: String?, settings: SettingsFacade, logger: AppLogger) {
    ...
    constructor(bookmarksFileName: File, settings: SettingsFacade, logger: AppLogger) {
        this.logger = logger
    ...
    constructor(settings: SettingsFacade, logger: AppLogger) {
        this.settings = settings
        this.logger = logger
